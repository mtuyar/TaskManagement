...
const AnalysisScreen = () => {
      ...
      <View style={styles.tabContent}>
          ...
          {(() => {
            ...
            return Object.keys(categories).map(category => {
              ...
              const percentage = filteredTasks.length > 0 ? 
                Math.round((count / filteredTasks.length) * 100) : 0;
              
              return (
                <View key={category} style={styles.frequencyItem}>
                  <View style={styles.frequencyItemHeader}>
                    <Text style={[styles.frequencyItemTitle, { color: theme.text }]}>
                      {category}
                    </Text>
                  ...
                  <View style={styles.frequencyItemBar}>
                    <View 
                      style={[
                        ...
                        { 
                          width: `${percentage}%`, 
                          backgroundColor: colors[category] || '#673AB7'
                        }
                      ]} 
                    />
                  </View>
        ...
        <View style={[styles.progressContainer, { backgroundColor: theme.card }]}>
          ...
          {(() => {
            ...
            const completedPercentage = filteredTasks.length > 0 ? 
              Math.round((completed / filteredTasks.length) * 100) : 0;
              ...
              <>
                <View style={styles.frequencyItem}>
                  <View style={styles.frequencyItemHeader}>
                    ...
                    <Text style={[styles.frequencyItemCount, { color: theme.text }]}>
                      {completed} vazife ({completedPercentage}%)
                    </Text>
                  </View>
                  ...
                  <View style={styles.frequencyItemBar}>
                    <View 
                      style={[
                        styles.frequencyItemFill, 
                        { width: `${completedPercentage}%`, backgroundColor: '#4CAF50' }
                      ]} 
                    />
                  </View>
                </View>
                ...
                <View style={styles.frequencyItem}>
                  <View style={styles.frequencyItemHeader}>
                    ...
                    <Text style={[styles.frequencyItemCount, { color: theme.text }]}>
                      {pending} vazife ({pendingPercentage}%)
                    </Text>
                  </View>
                  ...
                  <View style={styles.frequencyItemBar}>
                    <View 
                      style={[
                        styles.frequencyItemFill, 
                        { width: `${pendingPercentage}%`, backgroundColor: '#FFA000' }
                      ]} 
                    />
                  </View>
                </View>
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={[styles.tabButtonsContainer, { backgroundColor: theme.card }]}>
        <TabButtons />
      </View>
